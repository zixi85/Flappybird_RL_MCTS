...
def play_dueling_double_dqn(epoch=500, audio_on=False, render_mode="human", model_name="tiiuae/falcon-rw-1b", llm=False):
    ...
    model_path = os.path.join(MODEL_PATH, "DQN_dueling_double_qnet.pth")
    ...
    # score_limit = 200  # Set maximum score threshold
...
if __name__ == "__main__":
    results = [play_dueling_double_dqn() for _ in range(5)]
