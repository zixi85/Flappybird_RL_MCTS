...
def play_double_dqn(epoch=100, audio_on=False, render_mode="rgb_array", model_name="tiiuae/falcon-rw-1b", llm=False):
    ...
    model_path = MODEL_PATH + "/DQN_qnet.pth"
...
if __name__ == "__main__":
    results = [play_double_dqn() for _ in range(1)]
