...
def play_dueling_dqn(epoch=500, audio_on=False, render_mode="human", model_name="tiiuae/falcon-rw-1b", llm=False):
    ...
    # Initialize DuelingQNetwork
    q_net = DuelingQNetwork(state_dim, action_dim, hidden_dim)

    # Load trained model
    model_path = MODEL_PATH + "/DQN_dueling_qnet.pth"
...
if __name__ == "__main__":
    results = [play_dueling_dqn() for _ in range(5)]
