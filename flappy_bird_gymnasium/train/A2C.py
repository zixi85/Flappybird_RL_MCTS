...
def run_actor_critic(seed, clip=False, entropy=False, entropy_weight=0.01):
    ...
    while total_steps < max_steps:
        ...
        if episode_num % 50 == 0:
            ...
            torch.save(actor.state_dict(), f'{MODEL_PATH}/A2C_actor.pth')
            torch.save(critic.state_dict(), f'{MODEL_PATH}/A2C_critic.pth')
...
if __name__ == "__main__":
    ...
    df.to_csv('./results/a2c_episode_results.csv', index=False)

    print("\nResults saved to ./results/a2c_episode_results.csv")
