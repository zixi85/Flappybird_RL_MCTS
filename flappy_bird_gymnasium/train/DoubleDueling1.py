...
def run_dueling_double_dqn(seed):
    ...
    while total_steps < max_steps:
        ...
        if episode_num % 50 == 0:
            ...
            torch.save(q_net.state_dict(), f'{MODEL_PATH}/DQN_dueling_double_qnet_o.pth')
...
if __name__ == "__main__":
    ...
    df.to_csv('./results/dqn_dueling_double_o_results.csv', index=False)

    print("\nResults saved to ./results/dqn_dueling_double_o_results.csv")
    print("\nAvg Reward Summary:")
