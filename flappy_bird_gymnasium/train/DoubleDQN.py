...
def run_dqn(seed):
    ...
    while total_steps < max_steps:
        ...
        if episode_num % 50 == 0:
            ...
            torch.save(q_net.state_dict(), f'{MODEL_PATH}/DQN_qnet.pth')
...
if __name__ == "__main__":
    ...
    df.to_csv('./results/dqn_double_episode_results.csv', index=False)

    print("\nResults saved to ./results/dqn_double_episode_results.csv")
    print("\nAvg Reward Summary:")
